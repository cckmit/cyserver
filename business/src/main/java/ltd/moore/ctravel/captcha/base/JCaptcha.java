...
public class JCaptcha extends AbstractCaptcha {
    ...
    public final static String CODEER_NAME = "JCaptcha";
     ...
     * @throws IOException
     */
    public String outputVerifyImage(int w, int h, File outputFile,
     ...
     * @throws IOException
     */
    public String outputVerifyImage(int w, int h, OutputStream os,
                                    int verifySize) throws IOException {
        String verifyCode = generateVerifyCode(verifySize);
    ...
    public String generateCaptchaString() {
        return generateVerifyCode(4, VERIFY_CODES);
    }
