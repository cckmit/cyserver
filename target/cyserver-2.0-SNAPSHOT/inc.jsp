...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/jslib/Base64RichText.js"></script>

<script type="text/javascript" src="${pageContext.request.contextPath}/jslib/umeditor/umeditor.config.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/jslib/umeditor/umeditor.min.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/jslib/umeditor/lang/zh-cn/zh-cn.js"></script>
<link href="${pageContext.request.contextPath}/jslib/umeditor/themes/default/css/umeditor.css" type="text/css" rel="stylesheet">

<link rel="stylesheet"
	href="${pageContext.request.contextPath}/css/icon.css" type="text/css"/>
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/jslib/easyui/themes/icon.css"
	type="text/css"/>
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/css/frame.css" type="text/css"/>
<link rel="stylesheet" href="${pageContext.request.contextPath}/icons/icon-all.min.css"/>
<link rel="stylesheet" href="${pageContext.request.contextPath}/css/cy.css"/>
<link href="favicon.ico" rel="shortcut icon" />
<script type="text/javascript">
var pixel_0 = '${pageContext.request.contextPath}/images/pixel_0.gif';//0像素的背景，一般用于占位
var contextPath = '<%=basePath%>';
var contextPathx = '<%=basePath%>/page/alumni/loginx.jsp';
</script>