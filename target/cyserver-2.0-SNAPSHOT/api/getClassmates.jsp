...
<script type="text/javascript">
	function serFrom() {
		...
		var jsonStr = "{command:'" + command + "',content:{classId:'" + classId
				+ "'}}"
...
<body>
	<table align="center">
		<tr>
			<td><label style="font-size: 50px;">获取某个班级所有名单接口</label></td>
		</tr>
	</table>
	<table>
		<tr>
			<td align="right">command:</td>
			<td><input name="command" value="8" readonly="readonly">
			</td>
		</tr>
		<tr>
			<td align="right">classId:</td>
			<td><input name="classId" value=""></td>
		</tr>
		<tr>
