...
<footer class="ui-footer ui-footer-btn">
    <ul class="ui-tiled ui-border-t">
        <li data-href="donateIndex.jsp?accountNum=${param.accountNum}"><i class="fa fa-newspaper-o"></i>捐赠动态</li>
			<li data-href="donateNew.jsp?accountNum=${param.accountNum}" class="current"><i class="fa fa-heart-o"></i>最新捐赠</li>
...
<section class="ui-container">
    <div class="wrapper">
        <div class="inner">
            <ul class="ui-list ui-list-active ui-border-tb" id="newDonateList">
            </ul>
        </div>
    </div>
</section>
    ...
    Zepto(function($){
        ...
        var dropload = $('.inner').dropload({
            ...
            loadUpFn : function(me){
            	page=1;
                getPageData("${pageContext.request.contextPath}/donation/donationAction!doNotNeedSessionAndSecurity_listNew.action?page="+page+"&rows="+rows+"&accountNum="+${param.accountNum},"#newDonateList","update",newDonateListTpl,me);
            },
            loadDownFn : function(me){
            	page=page+1;
                getPageData("${pageContext.request.contextPath}/donation/donationAction!doNotNeedSessionAndSecurity_listNew.action?page="+page+"&rows="+rows+"&accountNum="+${param.accountNum}, "#newDonateList", "more", newDonateListTpl, me);
           
            }
        });

        //页面加载
        getPageData("${pageContext.request.contextPath}/donation/donationAction!doNotNeedSessionAndSecurity_listNew.action?page="+page+"&rows="+rows+"&accountNum="+${param.accountNum},"#newDonateList","onload",newDonateListTpl,null);
    });
