...
<%
	...
	String ids = WebUtil.isEmpty(request.getParameter("ids"))?"":request.getParameter("ids") ;
%>
...
<html>
	...
	//通过ajax查询
	var params = "ids="+ids;
	var url ="<%=path%>/association/associationMemberAction!doNotNeedSecurity_getSmsById_dataGrid.action";
	...
	function doSend(){
		...
		if($("#toAddress").val()==null || $("#toAddress").val() == ""){
				parent.$.messager.alert('错误', '请选择发件人', 'error');
    			return false;
		}
		...
		<fieldset>
			...
			<table class="ta001" >
				...
				<tr>
					...
					<td>
						<textarea id="toAddress" name="msgSend.telphone"  style="width:725px;height: 100px"readonly="readonly"></textarea>
