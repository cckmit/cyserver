...
//		fitColumns : true,
		...
		idField : 'newsId',
		 columns:[[
				...
				{field:'origin',title:'新闻来源',width:100,align:'center',
				...
				{field:'category',title:'手机栏目',width:150,align:'center',
					formatter: function(value,row,index){
				...
				{field:'categoryWeb',title:'网页栏目',width:100,align:'center',
					formatter: function(value,row,index){
				...
				{field:'operator',title:'操作',width:250,
						formatter: function(value,row,index){
							var content="";
