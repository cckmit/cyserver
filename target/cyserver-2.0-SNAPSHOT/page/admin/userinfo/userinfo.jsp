...
<html>
			...
			$(function(){
				deptTree = $('#deptTree').tree({
					...
					onClick : function(node) {
						$('#userFrame').attr('src','${pageContext.request.contextPath}/page/admin/userinfo/userInfoList.jsp')
					},
	...
	<body id="layout" class="easyui-layout" style="overflow-y: hidden"
		...
		<div data-options="region:'center'" style="overflow-y: hidden">
			<iframe id="userFrame" src="${pageContext.request.contextPath}/page/admin/userinfo/userInfoList.jsp" allowTransparency="true"
