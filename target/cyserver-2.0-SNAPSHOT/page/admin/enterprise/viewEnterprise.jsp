	  ...
	  <fieldset>
		  ...
		  <table class="ta001">
			  ...
			  <tr>
				  <th>企业类型</th>
				  <td>
					  <input id="type" name="enterprise.type" class="easyui-combobox" readonly style="width: 250px;" value=""
			  ...
			  <tr>
				  <th>融资阶段</th>
				  <td>
					  <input id="financingStage" name="enterprise.financingStage" class="easyui-combobox" readonly style="width: 250px;" value=""
							 data-options="editable:false,required:true,
							        valueField: 'dictValue',
							        textField: 'dictName',
