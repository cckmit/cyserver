    ...
    <script type="text/javascript">
        ...
        $(function () {
            eventGrid = $('#eventGrid').datagrid({
                url: '${pageContext.request.contextPath}/event/eventAction!getListAssociationEvent.action',
                fit: true,
                border: false,
//                fitColumns: true,
                striped: true,
        ...
        function resetT(){
            ...
            $('#associationName').combobox('clear');
        }
                ...
                <form id="searchForm">
                    ...
                    <table>
                        <tr>
                            ...
                            <td>
                                <input id="associationName" name="associationId" class="easyui-combobox" style="width: 150px;"
                                       data-options="
											valueField: 'id',
											textField: 'name',
											editable:false,
											url: '${pageContext.request.contextPath}/association/associationAction!doNotNeedSecurity_getAssociationList.action'
										" />
                            </td>
                            <th align="right">
                                标题
