                ...
                columns: [[
                    ...
                    formatter: function (value, row) {
						...
						if(row.nowStatus == '已删除') {
                        	...
                        	<authority:authority authorizationCode="编辑官方活动" userRoles="${sessionScope.user.userRoles}">
        ...
        <tr>
            <td>
                <table>
                    <tr>
                        <td>
                        	<authority:authority authorizationCode="新增官方活动" userRoles="${sessionScope.user.userRoles}">
                            <a href="javascript:void(0);" class="easyui-linkbutton"
