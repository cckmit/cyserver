	...
	<table class="ta001">
		...
		<tr>
			...
			<td>
				...
				>
					<option value="0"<c:if test="${formData.systemService=='0'}"> selected</c:if>>自定义服务</option>
					<option value="1"<c:if test="${formData.systemService=='1'}"> selected</c:if>>系统服务</option>
				</select>
			</td>
			...
			<td>
				<input type="text" id="sort" name="formData.sort" value="${formData.sort}">
			</td>
			</td>
		</tr>
		...
		<tr>
			...
			<td>
				<select id="need_authentication" name="formData.need_authentication" class="easyui-combobox" style="width:155px"
					...
					<option value="1" <c:if test="${formData.need_authentication=='1'}"> selected</c:if>>是</option>
					<option value="0" <c:if test="${formData.need_authentication=='0'}"> selected</c:if>>否</option>
				</select>
			</td>
			<th colspan="2" />
		</tr>
