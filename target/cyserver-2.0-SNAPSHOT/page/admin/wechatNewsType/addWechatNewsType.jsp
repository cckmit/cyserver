    ...
    <script type="text/javascript">
        ...
        function submitForm($dialog, $grid, $pjq)
        {
            ...
            if ($('form').form('validate')){
                $.ajax({
                    url : '${pageContext.request.contextPath}/wechatNewsType/wechatNewsTypeAction!saveWeChatNewsType.action',
                    data : $('form').serialize(),
                    dataType : 'json',
...
<form method="post" id="addNewsForm">
    <input id="parent_id" type="hidden" name="wechatNewsType.parentId" value="<%=parent_id %>">
    <fieldset>
        <legend>
            栏目信息
        </legend>
        <table class="ta001">
            ...
            <tr>
                ...
                <td colspan="3">
                    <select id="type" name="wechatNewsType.type" onchange="selectType();">
            ...
            <tr>
                ...
                <td colspan="3">
                    <input type="hidden" name="wechatNewsType.origin" value="<%=origin %>" />
