...
<form method="post" id="checkMessageBoardForm">
	<table class="ta001">
		...
		<tr>
			...
			<td colspan="3">
				<textarea rows="10" cols="80" name="replyMessageContent" disabled="disabled">${messageBoard.replyMessageContent}</textarea>
			</td>
		...
		<td colspan="3">
			<textarea rows="10" cols="80" disabled="disabled">${messageBoard.checkRemark}</textarea>
		</td>
	</table>
</form>
  </body>
