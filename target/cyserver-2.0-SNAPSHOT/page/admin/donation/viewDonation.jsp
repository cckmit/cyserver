...
<html>
	<head>
		...
		$(function() {
			...
			if (donationId > 0) {
				$.ajax({  
					url:'${pageContext.request.contextPath}/donation/donationAction!getById.action',
					data :{'id':donationId},
					dataType:'json',
...
//							    $('#')
		...
		function openMessage($dialog, $grid, $pjq, messageIsOpen) {
            ...
            $pjq.messager.confirm('确认', '确定'+text+'此留言？', function(r)
            {
                if(r){
                    $.ajax({
                        url : '${pageContext.request.contextPath}/donation/donationAction!update.action',
                        data : {
                            'donation.donationId':"${param.id}",
			...
			<fieldset>
				...
				<table class="ta001">
					...
					<tr id="itemName">
						...
						<td colspan="3">
							<input name="donation.itemName" disabled="disabled" style="width: 300px;"  class="easyui-validatebox" />
						</td>
					</tr>
					<tr id="thing">
						<th>
					...
					<tr >
						...
						<td>
							<input name="donationTime" disabled="disabled"/>
						</td>
						<th id="moneyName">
							<%--捐赠金额/物品价值/元--%>
						</th>
						<td >
							<input name="donation.money" disabled="disabled" style="width: 150px;" class="easyui-validatebox" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')"/>
						</td>
					</tr>
					<tr id="trpayTime">
						<th>
					...
					<tr>
						...
						<td colspan="3">
							<select class="easyui-combobox" disabled="disabled" data-options="editable:false" name="donation.messageIsOpen" style="width: 150px;">
			...
			<fieldset>
				...
				<table class="ta001">
					...
					<tr>
						...
						<td colspan="3">
							<input id="email" name="email"  disabled="disabled" style="width: 500px" type="text"/>
						</td>
						<%--<th>
							联系地址
						</th>
						<td>
							<input id="mailingAddress" name="mailingAddress" disabled="disabled" type="text"/>
						</td>--%>
					</tr>
					<tr>
						<th>
						...
						<td colspan="3">
							<input name="mailingAddress"  disabled="disabled" style="width: 500px" type="text"/>
						</td>
					</tr>
				</table>
			</fieldset>
