                    ...
                    success: function (result) {
                        if (result.donationId != undefined) {
                            $('form').form('load', {
                                ...
                                'donation.x_name': result.x_name,
                                'donation.x_phone': result.x_phone,
    ...
    <fieldset>
        ...
        <table class="ta001">
            ...
            <tr>
                ...
                <td colspan="3">
							<textarea id="content" name="project.content"></textarea>
                </td>
            </tr>
            <tr>
                <th>
    ...
    <fieldset>
        ...
        <table class="ta001">
            ...
            <tr>
                ...
                <td colspan="3">
                    <select id="donationType" name="donation.donationType" class="easyui-combobox" disabled="disabled"
            ...
            <tr>
                ...
                <td>
                    <input name="donation.donationTime" class="easyui-datetimebox"
                           data-options="editable:false,required:true"/>
                </td>
                <th>
                    捐赠金额/元
                ...
                <td>
                    <input id="money" name="donation.money"  disabled="disabled"></input>
                </td>
            </tr>
            <tr id="type">
                <th>
            ...
            <tr id="itemN">
                ...
                <td>
                    <input id="itemName" name="donation.itemName" class="easyui-validatebox"
                           ></input>
                </td>
                <th>
                    物品数量
                ...
                <td>
                    <input id="itemNum" name="donation.itemNum" class="easyui-validatebox" disabled="disabled" ></input>
                </td>
            </tr>
            ...
            <tr id="pay">
                ...
                <td>
                    <input id="payMoney" name="donation.payMoney" disabled="disabled"></input>
                </td>
                <th>
                    支付时间
                </th>
                <td>
                    <input name="payTime" class="easyui-datetimebox" disabled="disabled"/>
                </td>
            </tr>
            <tr id="trpayTime">
                <th>
                ...
                <td>
                    <select class="easyui-combobox" data-options="editable:false" name="donation.payStatus"
                            disabled="disabled">
            ...
            <tr id="payType">
                ...
                <td>
                    <select class="easyui-combobox" data-options="editable:false" name="donation.payType"
                            disabled="disabled">
                ...
                <td>
                    <select data-options="editable:false" name="donation.payMethod" class="easyui-combobox"
                            disabled="disabled">
            ...
            <tr id="trdonationCourier">
                ...
                <td>
                    <input name="donation.donationCourierNumber" class="easyui-validatebox" disabled="disabled"/>
                </td>
            </tr>
            <%--<tr id="trneedInvoice">
                <th>
            ...
            <tr>
                ...
                <td colspan="3">
                    ...
                    <input type="radio" name="donation.messageIsOpen" value="0" style="width: 20px;">未公开
            ...
            <tr id="payDetail">
                ...
                <td colspan="3">
                    <textarea rows="2" cols="100" name="donation.payDetail"></textarea>
                </td>
            </tr>
            <tr>
                <th>
                ...
                <td colspan="3">
                    <textarea rows="2" cols="100" name="donation.message"></textarea>
                </td>
            </tr>
            <tr>
                <th>
                ...
                <td colspan="3">
                    <textarea rows="2" cols="100" name="donation.remark"></textarea>
                </td>
            </tr>
        </table>
    </fieldset>
    ...
    <fieldset>
        ...
        <table class="ta001">
            <tr>
                ...
                <td colspan="3">
                    <input name="donation.donorType" class="easyui-combobox" disabled="disabled"
                           data-options="editable:false,
									        valueField: 'dictValue',
									        textField: 'dictName',
            ...
            <tr>
                ...
                <td colspan="3">
                    <input name="donation.donorName" class="easyui-validatebox" disabled="disabled"></input>
                </td>
            </tr>
            <tr>
                <th>
                ...
                <td colspan="3">
                    <input type="radio" name="donation.flag" value="0" style="width: 20px;" disabled="disabled">社会人士
                    <input type="radio" name="donation.flag" value="1" style="width: 20px;" disabled="disabled">校友
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <input type="radio" name="donation.needInvoice" value="0" style="width: 20px;">不需要
                    <input type="radio" name="donation.needInvoice" value="1" style="width: 20px;">需要
                </td>
            </tr>
            <tr>
                <div id="x">
            ...
            <tr>
                ...
                <td>
                    ...
                    <input id="departName" name="donation.x_depart" class="easyui-validatebox"
                ...
                <td>
                    <input id="gradeName" name="donation.x_grade" disabled="disabled" type="text"></input>
                </td>
            ...
            <tr>
                ...
                <td>
                    <input id="className" name="donation.x_clazz" disabled="disabled" type="text"></input>
                </td>
                <th>
                    性别
                </th>
                <td>
                    <input id="sex" name="donation.x_sex" disabled="disabled" type="text"></input>
                </td>
            </tr>
            <tr>
                <th>
                ...
                <td>
                    <input id="email" name="donation.x_email" disabled="disabled" type="text"></input>
                </td>
                <th>
                    联系地址
                </th>
                <td>
                    <input id="mailingAddress" name="donation.x_address" disabled="disabled" type="text"></input>
                </td>
            </tr>
        </table>
    </fieldset>
    ...
    <fieldset>
        ...
        <table class="ta001">
            <tr>
                ...
                <td>
                    <select class="easyui-combobox" disabled="disabled" data-options="editable:false"
                            name="donation.confirmStatus" style="width: 150px;">
