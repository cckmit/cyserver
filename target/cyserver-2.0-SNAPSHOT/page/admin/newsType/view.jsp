            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    if (result.id != undefined) {
						...
						if(result.typePic){
							$('#newsTypePic').append('<img src="'+ result.typePic +'"/>');
						}
...
<fieldset>
		...
		<table class="ta001">
			...
			<%--<tr>
				...
				<td colspan="3">
					<select id="channel" name="type.channel" disabled="disabled">
				...
				<tr>
					...
					<td colspan="3">
						<select id="channel"  name="type.channel" disabled="disabled" class="easyui-combobox" style="width: 150px;"
								data-options="
