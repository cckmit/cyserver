...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            var id = $('#activityMusicId').val();
            $.ajax({
                url: '${pageContext.request.contextPath}/activityMusic/activityMusicAction!getById.action',
                data: { 'activityMusicId' : id },
                dataType: 'json',
                success: function (result) {
                    ...
                    if (result.id != undefined) {
                        ...
                        $('form').form('load', {
                            ...
                            'activityMusic.activityId': result.activityId,
                            'activityMusic.type': result.type,
                            'activityMusic.isRepeatPlay': result.startTime,
                        });
        ...
        function submitForm($dialog, $grid, $pjq)
        {
            ...
            {
                $.ajax({
                    url : '${pageContext.request.contextPath}/activityMusic/activityMusicAction!update.action',
                    data : $('form').serialize(),
                    dataType : 'json',
                    success : function(result)
                    {
    ...
    <fieldset>
        ...
        <table class="ta001">
            <tr>
                ...
                <td colspan="3">
                    <input id="activityMusicId" name="activityMusic.id" type="hidden" value="${param.id}">
