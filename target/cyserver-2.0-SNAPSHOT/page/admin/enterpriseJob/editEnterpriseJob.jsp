    ...
    <fieldset>
        ...
        <table class="ta001">
            <tr>
                <th>校友企业</th>
                <td id="enterpriseTd">
                    <input name="enterpriseJob.id"  id="enterpriseId" type="hidden" value="${param.id}">
                    <input  name="enterpriseJob.enterpriseId" class="easyui-combobox" style="width: 150px;" value=""
