...
public class Recruitment implements Serializable {
    ...
    private String recruitmentUrl;//求职招聘详情url
    private String recruitmentUrl_xd;//求职招聘详情相对url
    ...
    public String getRecruitmentUrl_xd() {
        return recruitmentUrl_xd;
    }

    public void setRecruitmentUrl_xd(String recruitmentUrl_xd) {
        this.recruitmentUrl_xd = recruitmentUrl_xd;
    }
}
