...
public class PinYin2Abbreviation {
    ...
    /**
     * 获取字符串首字母，如首字母不是英文字母，则为“#”
     * @param ele
     * @return
     */
    public static String getFirstLetter(String ele) {
        String firstLetter = null ;
        if(StringUtils.isNotBlank(ele)) {
            String py = cn2py(ele).toUpperCase() ;
            char letter = py.charAt(0) ;
    ...
    public static void main(String[] args) throws Exception {
        String py = cn2py("周嘉福").toUpperCase() ;
        System.out.println(py.charAt(0)) ;
        System.out.println(getFirstLetter("周嘉福")) ;
        System.out.println(getFirstLetter("1111周嘉福")) ;
        System.out.println(getFirstLetter("韩闯")) ;
