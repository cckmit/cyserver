...
import com.cy.alipay.util.httpClient.HttpProtocolHandler;
import com.cy.alipay.util.httpClient.HttpRequest;
import com.cy.alipay.util.httpClient.HttpResponse;
import com.cy.alipay.util.httpClient.HttpResultType;
import com.cy.alipay.sign.MD5;
...
public class AlipaySubmit {
    ...
    public static String buildRequest(String strParaFileName, String strFilePath,Map<String, String> sParaTemp) throws Exception {
        ...
        //设置编码集
        request.setCharset(AlipayConfig._input_charset);

        request.setParameters(generatNameValuePair(sPara));
        request.setUrl(ALIPAY_GATEWAY_NEW+"_input_charset="+AlipayConfig._input_charset);
