...
<div id="main">
	...
	<form name="alipayment" action="${ctx}/alipay/alipayApi" method="post" target="_blank" accept-charset="utf-8">
			...
			<dl class="content">
				...
				<dd>
					...
					<input size="30" name="WIDshow_url" />
						<span>需以http://开头的完整路径，例如：http://www.xxx.com/myorder.html</span>
				</dd>
				<dt></dt>
				<dd>
