...
<html>
	...
	$(function()
	{
				userInfoGrid = $('#userInfoGrid').datagrid({
					url : '${pageContext.request.contextPath}/userInfo/userInfoAction!dataGridForAlumni.action',
					fit : true,
					method : 'post',
					border : false,
					striped : true,
					...
					},
					{
						...
						{
							var str = '';
							<authority:authority authorizationCode="查看学生" userRoles="${sessionScope.user.userRoles}">
	...
	var viewFun = function(id)
	{
		var dialog = parent.parent.WidescreenModalDialog({
			...
			url : '${pageContext.request.contextPath}/page/admin/alumni/viewUserInfo.jsp?id=' + id
		});
	}
						...
						<form id="searchForm">
							<table>
								...
								<tr>
									...
									<td>
										<input class="easyui-combobox" name="userInfo.alumniId" id="alumni" style="width: 150px;"
										data-options="
