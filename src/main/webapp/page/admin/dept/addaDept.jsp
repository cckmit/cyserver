			...
			<fieldset>
				...
				<table class="ta001">
					...
					<tr>
						...
						<td>
							<select name="dept.departId" class="easyui-combobox" data-options="required:true,editable:false,valueField:'deptId',textField:'deptName',url:'${pageContext.request.contextPath}/dept/deptAction!doNotNeedSecurity_getDeptAlias1.action'" style="width: 150px;"></select>
						</td>
					</tr>
