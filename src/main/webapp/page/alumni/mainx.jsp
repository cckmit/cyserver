...
<html>
	...
	<script type="text/javascript">
		...
		$(function(){
			mainMenu = $('#mainMenu').tree({
				url : '${pageContext.request.contextPath}/login/loginAction!doNotNeedSecurity_initMenu.action',
				parentField : 'pid',
	...
	<body id="mainLayout" class="easyui-layout" style="overflow-y: hidden" scroll="no">
		<div data-options="region:'north',href:'${pageContext.request.contextPath}/page/alumni/northx.jsp'"  style="height: 70px; overflow: hidden;background-image: url('images/cctop.jpg');background-repeat: repeat-x;">
		</div>
		<div data-options="region:'south'" style="height: 30px;">
			<div align="center" style="margin-top: 5px;">
				Copyright © 2014 cy199.cn All Rights Reserved.
			</div>
		</div>
		...
		<div data-options="region:'center'" style="overflow-y: hidden">
			<div id="mainTabs">
				<div title="我的主页" data-options="iconCls:'ext-icon-homePage'">
					<iframe src="${pageContext.request.contextPath}/page/alumni/welcomex.jsp" allowTransparency="true"
