...
<script type="text/javascript">
	function serFrom() {
		...
		var jsonStr = "{command:'" + command + "',content:{accountNum:'"
				+ accountNum + "',password:'" + password + "',name:'" + name
...
<body>
	<table align="center">
		<tr>
			<td><label style="font-size: 50px;">根据姓名和其它信息查询用户接口</label></td>
		</tr>
	</table>
	<table>
		<tr>
			<td align="right">command:</td>
			<td><input name="command" value="22" readonly="readonly">
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><input name="profession" value=""></td>
		</tr>
		<tr>
