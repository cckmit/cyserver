        ...
        factory(window['H'] = {
            ...
            showProgress: function (title, text, isModal, options) {
                ...
                if (that.isAPICloud()) {
                	...
                	that.toastCore('<span class="H-display-block H-line-height-normal H-animate-rotate"><i class="H-iconfont H-icon-loading H-font-size-42"></i></span>', "加载中...");
                }
            },
            ...
            //生成节点
            dialogCorem: function (type, title, msg, buttons) {
                ...
                var contentHtml = "";
                contentHtml += '<div class="H-dialog H-theme-background-color-white animated zoomIn" style="-webkit-animation-duration: 0.3s; animation-duration: 0.3s;width: ' + (clientWidth - 100) + 'px; min-height: 80px;border-radius: 5px">';
                contentHtml += '<div class="H-dialog-content H-padding-10 H-word-break-break-all H-font-size-16 H-theme-font-color-666 H-text-align-center"><img src="static/img/out_class.png" style="width: 50px;height: 50px;margin-top: 10px"><div style="padding: 10px">'+ msg + '</div></div>';
                contentHtml += '<div class="H-dialog-buttons H-flexbox-horizontal H-border-vertical-top-after">';

                if (buttons && buttons.length > 0) {
                    for (var i = 0; i < buttons.length; i++) {
                        if (i == (buttons.length - 1) && buttons.length > 1) {
                            contentHtml += '<div class="H-dialog-button H-border-horizontal-right-after H-flex-item H-font-size-16 H-padding-10 H-center-all H-touch-active H-theme-font-color-white" style="background: #999999">' + buttons[i] + '</div>';
                        }
                        else {
                            contentHtml += '<div class="H-dialog-button H-border-horizontal-right-after H-flex-item H-font-size-16 H-padding-10 H-center-all H-touch-active H-theme-font-color-white" style="background: #3498db">' + buttons[i] + '</div>';
                        }
                    }
                }
                contentHtml += '</div>';
            ...
            // jiangling 针对 "秩年返校"- "我的计划"/"我的"计划列表中- 对"不通过"审核的用户提示
            dialogCoreForPlan: function (type, title, msg, buttons) {

                var that = this;
                title = title ? title : "活动建议：";
                var clientWidth = window.document.body.clientWidth;

                var contentHtml = "";
                contentHtml += '<div class="edit_confirm_box H-dialog H-theme-background-color-white animated zoomIn" ' +
                    'style="-webkit-animation-duration: 0.3s; animation-duration: 0.3s;width: ' + (clientWidth - 50) + 'px; min-height: 80px;">';
                contentHtml += '<div class="H-dialog-title H-padding-10 H-font-size-16 H-line-height-normal H-text-align-center H-theme-background-color1 H-theme-font-color-white">' + title + '</div>';
                contentHtml += '<div class="H-dialog-content H-padding-10 H-word-break-break-all H-font-size-16 H-theme-font-color-666 H-text-align-center">' + msg + '</div>';
                contentHtml += '<div class="H-dialog-buttons H-flexbox-horizontal H-border-vertical-top-after">';
                ...
                if (buttons && buttons.length > 0) {
                    for (var i = 0; i < buttons.length; i++) {
                        if (i == (buttons.length - 1) && buttons.length > 1) {
                            contentHtml +=
                                '<div class="H-dialog-button H-flex-item H-font-size-16 H-padding-10 H-center-all H-touch-active H-theme-font-color1">' +
                                buttons[i] +
                                '</div>';
                        }
                        else {
                            contentHtml += '<div class="H-dialog-button H-border-horizontal-right-after H-flex-item H-font-size-16 H-padding-10 H-center-all ' +
                                'H-touch-active H-theme-font-color1">' + buttons[i] + '</div>';
                        }
                    }
                }
                contentHtml += '</div>';
                ...
                if (that.Ds(".H-dialog-area") && that.Ds(".H-dialog-area").length > 0) {
                    ...
                    var html = "";
                    html += '<div id="editPlanMask" class="edit_plan_mask H-dialog-area H-display-none-important H-position-absolute H-vertical-top-0 H-center-all ' +
                        'H-horizontal-right-0 H-vertical-bottom-0 H-horizontal-left-0 H-background-color-transparent-3" style="z-index:1234567890123">';
                    html += contentHtml;
                    html += '</div>';
                    that.prepend(document.body, null, html);
                }
            ...
            // jiangling 针对 "秩年返校"- "我的计划"/"发起"表单- 提示用户发起成功
            dialogCoreForSuccuss: function (type, title, msg, buttons) {

                // console.log("提示信息:"+"type=="+type+" | msg= "+msg+"| title="+title+"buttons="+buttons);


                var that = this;
                title = title ? title : "恭喜您!";
                var clientWidth = window.document.body.clientWidth;
                ...
                contentHtml +=
                    ...
                    'style="-webkit-animation-duration: 0.3s; animation-duration: 0.3s;width: ' + (clientWidth - 50) + 'px; min-height: 80px;">';
                // icon
                contentHtml += '<div class="H-text-align-center H-padding-vertical-top-20">' +
                    '<span class="H-icon H-display-block H-horizontal-center">'+
                    '<i class="H-iconfont H-icon-star-fill H-font-size-28 H-vertical-middle H-theme-font-color1" style="font-size:5rem;"></i>'+
                    '</span>'
                    '</div>';
                contentHtml += '<div id="messageWin" ' +
                    'class="H-dialog-content H-padding-10 H-word-break-break-all H-font-size-16 H-theme-font-color-666 H-text-align-center">' + msg + '</div>';
                /*contentHtml +=
                    ...
                    'H-theme-font-color-white H-touch-active H-text-align-center H-width-100-percent H-margin-vertical-top-20 H-border-radius-9-right-bottom H-border-radius-9-left-bottom">';*/
               contentHtml +='<div class="H-dialog-buttons">';

                if (buttons && buttons.length > 0) {
                    for (var i = 0; i < buttons.length; i++) {
                        if (i == (buttons.length - 1) && buttons.length > 1) {
                            contentHtml +=
                                '<div class="H-dialog-button H-flex-item H-font-size-16 H-padding-10 ' +
                                'H-center-all H-touch-active H-theme-background-color1 H-theme-font-color-white">' + buttons[i] + '</div>';
                        }
                        else {
                            contentHtml +=
            ...
            // jiangling 针对 "信息认证"- 提示用户认知失败
            dialogCoreForFail: function (type, title, msg, buttons) {
                ...
                contentHtml +=
                    ...
                    '   <div class="H-padding-vertical-top-0">' +
                    '   <span class="H-icon H-display-block H-horizontal-center">'+
                    '       <i class="H-icon H-iconfont H-icon-guanbi2-fill H-vertical-middle H-theme-font-color-999" style="font-size:55px;"></i>'+
                    '   </span>'
                    '</div>';
                contentHtml +=
                    '<div class="H-padding-10 H-word-break-break-all H-font-size-16 H-theme-font-color-666" style="padding-top:0; padding-bottom:25px;">' + msg + '</div>' +
                    '</div>'+
                    '</div>';


                contentHtml +=' <div class="H-dialog-buttons H-flexbox-horizontal" style="border-bottom-left-radius: 9px; border-bottom-right-radius: 9px;">';
                    ...
                    for (var i = 0; i < buttons.length; i++) {
                        if (i == (buttons.length - 1) && buttons.length > 1) {
                            contentHtml +=
                                ...
                                'H-padding-10 H-center-all H-touch-active H-theme-font-color-white H-theme-background-color16" style="border-bottom-left-radius: 9px; border-bottom-right-radius: 9px;">' + buttons[i] + '</div>';
                        }
                        else {
                            contentHtml +=
                                '<div class="H-dialog-button H-border-horizontal-right-after H-flex-item H-font-size-16 H-padding-10 ' +
                                'H-center-all H-touch-active H-theme-background-color16 H-theme-font-color-white" style="border-bottom-left-radius: 9px; border-bottom-right-radius: 9px;">' + buttons[i] + '</div>';
                        }
                    }
                }
                contentHtml += '</div>';
            ...
            // 下拉选择
            selectTip: function (element, items,items2, okCallback, cancelCallback) {
                var that = this;
                ...
                if (items && items.length > 0) {
                    for (var i = 0; i < items.length; i++) {
                        html += '<div class="H-select-item H-font-size-16 H-theme-font-color-black H-center-all H-height-45"><div style="display:none">' + items2[i] + '</div>' + items[i] + '</div>';
                    }
                }
                else {
                ...
                that.on(that.D(".H-select-ok"), "touchend", function (event) {
                    isCancel = false;
                    currentSelectValue = that.D(".H-select-item:nth-child(" + (currentSelectIndex + 1) + ")").innerText;
                    currentSelectValuey = that.D(".H-select-item:nth-child(" + (currentSelectIndex + 1) + ")").firstChild.innerText;
                    that.cssText(that.D('.H-select-list'), "-webkit-animation-duration: 0.4s; animation-duration: 0.4s;");
                    that.addClass(that.D('.H-select-list'), 'slideOutDown');
                });
                    ...
                    if (that.hasClass(that.D('.H-select-list'), 'slideOutDown')) {
                        ...
                        if (isCancel == true) {
                            ...
                            if (that.isFunction(okCallback)) {
                                okCallback(currentSelectIndex, currentSelectValue,currentSelectValuey);
                            }
                        }
                    }
                });
            },
            // 下拉选择--自定义扩展，数据格式接收json数组格式
            selectTipByJsonArray: function (element, items, okCallback, cancelCallback, defaultId) {
                var that = this;
                if (that.Ds(".H-select-area") && that.Ds(".H-select-area").length > 0) {
                    document.body.removeChild(that.D(".H-select-area"));
                }
                ...
                if (items && items.length > 0) {
                    for (var i = 0; i < items.length; i++) {
                        html += '<div id="' + items[i].id + '" class="H-select-item H-font-size-16 H-theme-font-color-black H-center-all H-height-45">' + items[i].name + '</div>';
                    }
                }
                else {
                    html += '<div class="H-select-item H-font-size-16 H-theme-font-color-black H-center-all H-height-45">请选择</div>';
                ...
                that.on(that.Ds(".H-select-cancel,.H-select-space"), "touchend", function (event) {
                    isCancel = true;
                    currentSelectId = that.D(".H-select-item:nth-child(" + (currentSelectIndex + 1) + ")").getAttribute("id");
                    currentSelectValue = that.D(".H-select-item:nth-child(" + (currentSelectIndex + 1) + ")").innerText;
                    that.cssText(that.D('.H-select-list'), "-webkit-animation-duration: 0.4s; animation-duration: 0.4s;");
                    that.addClass(that.D('.H-select-list'), 'slideOutDown');
                });
                ...
                that.animationEventEnd(".H-select-list", function (event) {
                    ...
                    if (that.hasClass(that.D('.H-select-list'), 'slideOutDown')) {
                        ...
                        if (isCancel == true) {
                            if (that.isFunction(cancelCallback)) {
                                cancelCallback(currentSelectIndex, currentSelectValue, currentSelectId);
                            }
                        }
                        else {
                            if (that.isElement(element)) {
                            ...
                            if (that.isFunction(okCallback)) {
                                okCallback(currentSelectIndex, currentSelectValue, currentSelectId);
                            }
                        }
                    }
                });
            ...
            // jiangling 针对 "秩年返校"- "我的计划"/"我的"计划列表中- 对"不通过"审核的用户提示
            alertTipForPlan: function (callback, msg, title, buttons) {
                var that = this;
                if ((!that.isFunction(arguments[0])) && (arguments[0])) {
                    msg = arguments[0];
                }
                ...
                // 生成HTML
                that.dialogCoreForPlan("text", title, msg, buttons);  // that function add by jiangling

                that.removeClass(that.D('.edit_plan_mask'), "H-display-none-important");
                that.on(that.Ds('.H-dialog-button'), "touchend", function (e) {
                    var index = that.getIndex(that.getParents(event.target, "H-dialog-button"));
                    that.addClass(that.D('.H-dialog'), 'zoomOut');
                    setTimeout(function(){
                ...
                that.animationEventEnd(that.D('.H-dialog'), function (event) {
                    if (that.hasClass(that.D('.edit_plan_mask'), "H-display-none-important") == false) {
                        that.removeClass(that.D('.H-dialog'), 'zoomIn');
                    }
                    if (that.hasClass(that.D('.H-dialog'), 'zoomOut')) {
                        that.addClass(that.D('.edit_plan_mask'), "H-display-none-important");
                        if (that.isFunction(callback)) {
                            callback();
                        }
                    }
            ...
            // jiangling "发起"表单中成功发起计划 提示用户
            alertTipForSuccuss: function (callback, msg, title, buttons) {
                // console.log("callback="+callback +"|msg="+msg + "| title="+title +"|buttons="+buttons);
                var that = this;
                ...
                // 生成HTML
                that.dialogCoreForSuccuss("text", title, msg, buttons);  // that function add by jiangling
            ...
            // jiangling 针对"信息认证"-认证失败 提示用户
            alertTipForFail: function (callback, msg, title, buttons) {
                // console.log("callback="+callback +"|msg="+msg + "| title="+title +"|buttons="+buttons);
                var that = this;
                ...
                // 生成HTML
                that.dialogCoreForFail("text", title, msg, buttons);  // that function add by jiangling
            ...
            //mcz--退出班级询问框
            confirmoutclass: function (callback, title, msg, buttons) {
                var that = this;
                ...
                var _err = {};
                // 生成HTML
                that.dialogCorem("text", title, msg, buttons.reverse());
            ...
            promptTip: function (callback, title, msg, text, type, buttons) {
                ...
                var _msg = '<div class="H-dialog-prompt-tip H-font-size-16">' + msg + '</div>' +
                    '<input type="text" class="H-dialog-prompt-text H-width-100-percent H-border-none padding H-padding-10 H-box-sizing-border-box H-box-shadow-inset" ' +
                    'style="border:1px solid #f1f1f1;" placeholder="请输入内容..." value="' + text + '" />';
