...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/mobile/css/font-awesome.min.css">
...
<script type="text/javascript" src="${pageContext.request.contextPath}/mobile/js/messageBoard.js?<%= Math.random() %>"></script>
