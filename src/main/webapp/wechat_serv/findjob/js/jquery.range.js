	...
	jRange.prototype = {
		...
		template: '<div class="slider-container">\
			<div class="back-bar">\
                ...
                <div class="pointer low"></div><div class="pointer-label minT">0</div>\
                <div class="pointer high"></div><div class="pointer-label maxT">100</div>\
		...
		showPointerValue: function(pointer, position, animate) {
			...
			var fanweimin=$('.fanweimin');
			var fanweimax=$('.fanweimax');

			if ($.isFunction(this.options.format)) {
				var type = this.isSingle() ? undefined : (pointer.hasClass('low') ? 'low' : 'high');
				text = this.options.format(value, type)+'k';
			} else {
				text = this.options.format.replace('%s', value)+'k';
			}
			...
			if($('.minT').html()=='0k'&&$('.maxT').html()=='100k'){
				fanweimax.html('不限');
			}else{
				fanweimin.html($('.minT').html());
				fanweimax.html($('.maxT').html());
			}
