...
<form id="customerDetailEditForm" action="${webRoot}/customerDetail/save" method="post">
    ...
    <table class="table-list">
        <tr>
            ...
            <td>
                <input id="account" class="easyui-textbox"  data-options="required:true,novalidate:true,validType:['specialCharacters','nospace','lengthCharacter[50,100]']" title="该输入项为必输项" name="account"  prompt="请输入登录帐号" value="${(customerAccountVO.account)!''}">
            </td>
            <td class="t-title" width="30%" align="center">客户类型：<font style="color:red">*</font></td>
            <td>
                <input type="hidden" id="customerType" />
                <input type="radio" id="customerType1" name="customerType" value="1" checked="true"/>普通用户
                <input type="radio" id="customerType2" name="customerType" value="2" />达人
            </td>
        </tr>
        <tr>
            ...
            <td>
                <input id="password" class="easyui-textbox" data-options="required:true,novalidate:true,validType:['noChinese','nospace','specialCharactersComma','length[0,100]']" title="该输入项为必输项" type="password" name="password"  value="">
            </td>
            <td class="t-title" width="30%">确认密码：<font style="color:red">*</font></td>

            <td>
                <input data-options="required:true,novalidate:true" title="该输入项为必输项" id="repassword" maxlength="100"  name="repassword" type="password" value=""
                       class="easyui-textbox" validType="equalTo['#password']" invalidMessage="两次密码输入不匹配" />
            </td>
        ...
        <tr>
            ...
            <td>
                <input id="nickName" class="easyui-textbox"  data-options="novalidate:true,validType:['specialCharacters','nospace','lengthCharacter[50,100]']" title="该输入项为必输项" name="nickName"  value="${(customerDetailVO.nickName)!''}">
            </td>
            <td class="t-title" width="30%"  align="left">性别：</td>
            <td>
        ...
        <tr>
            ...
            <td>
                <input id="imToken" class="easyui-textbox"  data-options="novalidate:true,validType:['specialCharacters','nospace','lengthCharacter[50,100]']" title="该输入项为必输项" name="imToken"  value="${(customerDetailVO.imToken)!''}">
            </td>
        ...
        <table class="table-list">
            <tr >
                <td class="t-title" style="width:15%;padding: 0px 4px;"  >法人身份证扫描件（正反面）：<div style="float:right;padding:3px 0px 0px 0px;color:red">*</div></td>
                <td style="width:250px;padding: 0px 4px;">
                    ...
                    <div style="margin-top:14px; border:1px solid #c0c0c0">
                        <img id = "idcardImage" class="pimg" src="${webRoot}/statics/images/sfz.png" width="70" height="70">
                    </div>
            ...
            <tr>
                <td class="t-title" style="width:15%;padding: 0px 4px;"  >客户头像：<div style="float:right;padding:3px 0px 0px 0px;color:red">*</div></td>
                <td style="width:250px;padding: 0px 4px;">
                    ...
                    <div style="margin-top:14px; border:1px solid #c0c0c0">
                        <img class="pimg" id = "headImage" src="${webRoot}/statics/images/youcai.jpg" width="70" height="70">
                    </div>
                </td>
                <td>
                    <span>照片所有信息需清晰可见，内容真实有效，不得做任何修改。照片支持.jpg .jpeg .bmp .gif .png格式，大小不超过8M。</span>
...
<script>
    ...
    $(function(){
        var attachment = $("#attachmentEdit1");idcardImg
    ...
    function saveCustomerDetail() {
        $("#customerDetailEditForm").form({
            url:"${webRoot}/customerAccount/save",
            onSubmit:function(){
                if($("#idcardImg").val() == '' || $("#headImg").val() == '' ){
                    $.messager.alert('提示','请上传身份证和头像!','info');
                    return false;
                }
            ...
            success:function(data) {
                ...
                parent.reloadData("customerAccountTable");
                closeWindow();
            }
        });
        $("#customerDetailEditForm").submit();
    }
